...
public class CharmanderScroller{
	...
	public CharmanderScroller() {
		
		//load the main image (front or forward view) 
		
		
		forward 	= getImage("/imgs/"+"fire-type-symbol-pixilart.png"); //load the image for Tree
	...
	public CharmanderScroller(int x, int y) {
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = CharmanderScroller.class.getResource(path);

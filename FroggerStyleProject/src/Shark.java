...
public Shark() {
forward = getImage("/imgs/Shar.png");//Load the image for the

// Initialize size, position, and velocity
width = (int) (70*scaleWidth); // Set width from image dimensions
height =(int) (40*scaleHeight); // Set height from image dimensions
...
public boolean collided(Marlin character) {
	...
	Rectangle Shark = new Rectangle(x,y,width,height);
	return main.intersects(Shark);
}

public Shark(int x, int y, int spacing, int vx) {
	this();
	this.x=x;
	this.y=y;

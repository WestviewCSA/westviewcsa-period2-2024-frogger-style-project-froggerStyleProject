...
public class CharmanderScroller2{
	...
	public CharmanderScroller2() {
		
		//load the main image (front or forward view) 
		
		
		forward 	= getImage("/imgs/"+"sr24fba8d3b82aws3.png"); //load the image for Tree
	...
	public CharmanderScroller2(int x, int y) {
	...
	private Image getImage(String path) {
		...
		try {
			URL imageURL = CharmanderScroller2.class.getResource(path);
